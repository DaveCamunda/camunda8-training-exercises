...
@worker.task(task_type="calculate-discount")
async def calculate_discount_task(orderTotal: float, discount: int) -> dict:
    print("Calculating discount...")
    return calculate_discount(orderTotal, discount)
